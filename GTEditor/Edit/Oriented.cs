...
namespace GTEditor.Edit
{
    ...
    class Oriented : IEditor
    {
        ...
        public Oriented(Graph graph)
        {
            if (graph == null) { throw new Exception("Oriented editor got null graph"); }
            if (!graph.IsOriented) { throw new Exception("Oriented editor got non-oriented graph"); }
        ...
        public void addEdge(IEdge e)
        {
            ...
            {
                if (ed.vertex_1 == e.vertex_1 && ed.vertex_2 == e.vertex_2)
                {
                    return;
                }
            }
